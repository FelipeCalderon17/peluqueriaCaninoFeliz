...
if (
    ...
    $sql4 = "SELECT fecha_cita from cita where estado='Activo'";
    ...
    if (isset($_SESSION['errorFechaCogida']) && !empty($_SESSION['errorFechaCogida']) || isset($_SESSION['errorFechaAnterior']) && !empty($_SESSION['errorFechaAnterior'])) {
        header("Location: ../vista/citasyServicios.php");
    } else {
